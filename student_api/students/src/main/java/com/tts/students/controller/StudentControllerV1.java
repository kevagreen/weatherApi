...
public class StudentControllerV1 {
    ...
    @ApiOperation(value = "Get Students by Id", response = StudentV1.class, responseContainer = "Optional")
    @GetMapping("/{id}")
    ...
    @ApiOperation(value = "Get all students", response = StudentV1.class, responseContainer = "List")
    @GetMapping("/all")
